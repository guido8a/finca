    ...
    <table class="table table-bordered table-striped table-condensed table-hover">
        ...
        <tr>
            ...
            <g:each in="${finca.Finca.list().sort{it.nombre}}" var="finca">
                <th style="width: 7%">${finca?.nombre}</th>
            </g:each>
            <th style="width: 7%">Guardar</th>
        </tr>
        </thead>
    </table>
            ...
            <table class="table-bordered table-striped table-condensed table-hover">
                ...
                <tr data-id="${dt.dtor__id}" class="${dt?.dtoretdo == '1' ? 'registrado' : ''}">
                    ...
                    <g:each in="${finca.Finca.list().sort{it.nombre}}" var="fincaTD" status="i">
                        <td style="width: 7%">
                            <g:textField name="${fincaTD}_${i}" value="${0}" style="width: 50px" />
                        </td>
                    </g:each>
                    <td style="width: 7%">
                        <a href="#" class="btn btn-success btn-xs btnGuardarDistribucion" data-id="${dt.dtor__id}"
                           data-producto="${dt?.prodnmbr}" title="Guardar">
