...
<script type="text/javascript">
    ...
    function verificarPerfiles () {
        ...
        if(perfiles !== ''){
            ...
            bootbox.confirm({
                message: "<i class='fa fa-3x fa-exclamation-triangle text-danger'></i> <strong style='font-size: 14px'> No ha seleccionado ningún perfil. El usuario no podrá ingresar al sistema. ¿Desea continuar?. </strong>",
                buttons: {
                    confirm: {
                        label: 'Borrar',
