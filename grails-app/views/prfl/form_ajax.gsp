    ...
    <g:form class="form-horizontal" name="frm" role="form" action="save" method="POST">
        ...
        <div class="form-group ${hasErrors(bean: prflInstance, field: 'descripcion', 'error')} ">
            <span class="grupo">
                ...
                <div class="col-md-6" style="width: 380px;">
                    <g:textField name="descripcion" class="form-control" value="${prflInstance?.descripcion}" style="width: 360px;" maxlength="60"/>
                </div>*
        ...
        <div class="form-group ${hasErrors(bean: prflInstance, field: 'nombre', 'error')} ">
            <span class="grupo">
                ...
                <div class="col-md-6"  style="width: 380px">
                    <g:textField name="nombre" class="form-control" value="${prflInstance?.nombre}" maxlength="60" style="width: 360px"/>
                </div> *
        ...
        <div class="form-group ${hasErrors(bean: prflInstance, field: 'observaciones', 'error')} ">
            <span class="grupo">
                ...
                <div class="col-md-6" style="width: 380px;">
                    <g:textField name="observaciones" class="form-control" value="${prflInstance?.observaciones}" style="width: 360px;" maxlength="60"/>
                </div> *
            </span>
        </div>
